...
// Allows users to auto-scroll down the page continuously
// ═══════════════════════════════════════════════════════════
 ...
 * Continuously scrolls the page down or stops scrolling
 */
...
/**
 * Initialize auto-scroll button visibility
 * Shows button when user scrolls down enough and hasn't reached bottom
 */
function initAutoScrollBtn() {
  ...
  window.addEventListener('scroll', () => {
    ...
    if (window.scrollY > scrollThreshold && !isNearBottom) {
